...
public class Main {
    public static void main(String[] args) {
        ...
        while(run){
            ...
            System.out.println("7. Filter/Sort/Search Transactions");
            ...
            switch(choice){
                ...
                case 5: controller.saveToFile("data/transactions.csv"); break;
                case 6: controller.loadFromFile("data/transactions.csv"); break;
                case 7: filterSortSearchUI(controller, sc); break;
    ...
    private static void filterSortSearchUI(TransactionController controller,Scanner sc){
    ...
    private static void displayTransaction(List<Transaction> transactions){
        if (transactions.isEmpty()){
